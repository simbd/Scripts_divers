...
GUI=$(zenity --list --checklist --height 850 --width 1400 \
	...
	FALSE "$SCT_SESSION" "===========================================================" \
    	$(chkDef "TRUE") "$CA_GNOMEVANILLA" "$CD_GNOMEVANILLA" \
	...
	FALSE "$SCT_BROWSER" "===========================================================" \
    	...
    	$(chkDef "TRUE") "$CA_FIREFOXDEVELOPER" "$CD_FIREFOXDEVELOPER" \
    	$(chkDef "FALSE") "$CA_FIREFOXESR" "$CD_FIREFOXESR" \
    	$(chkDef "TRUE") "$CA_FIREFOXNIGHTLY" "$CD_FIREFOXNIGHTLY" \
    	...
    	$(chkDef "TRUE") "$CA_TORBROWSER" "$CD_TORBROWSER" \
    	$(chkDef "TRUE") "$CA_VIVALDI" "$CD_VIVALDI" \
	FALSE "$SCT_INTERNET" "===========================================================" \
	...
	$(chkDef "TRUE") "$CA_HEXCHAT" "$CD_HEXCHAT" \
	...
	$(chkDef "FALSE") "$CA_PIDGIN" "$CD_PIDGIN" \
	...
	$(chkDef "TRUE") "$CA_WEECHAT" "$CD_WEECHAT" \
	...
	$(chkDef "TRUE") "$CA_CLUSTERSSH" "$CD_CLUSTERSSH" \
	...
	$(chkDef "TRUE") "$CA_XNVIEW" "$CD_XNVIEW" \
	...
	$(chkDef "FALSE") "$CA_HANDBRAKE" "$CD_HANDBRAKE" \
  ...
  $(chkDef "FALSE") "$CA_SHOTCUT" "$CD_SHOTCUT" \
	...
	$(chkDef "TRUE") "$CA_CONVERTALL" "$CD_CONVERTALL" \
	...
	$(chkDef "TRUE") "$CA_GNOMEBOXES" "$CD_GNOMEBOXES" \
	$(chkDef "FALSE") "$CA_GNS" "$CD_GNS" \
	$(chkDef "TRUE") "$CA_QEMUKVM" "$CD_QEMUKVM" \
  ...
  $(chkDef "FALSE") "$CA_WINE" "$CD_WINE" \
	...
	$(chkDef "FALSE") "$CA_BITCOINCORE" "$CD_BITCOINCORE" \
    	...
    	$(chkDef "TRUE") "$CA_GITCOLA" "$CD_GITCOLA" \
	...
	$(chkDef "TRUE") "$CA_MULTISYSTEM" "$CD_MULTISYSTEM" \
	...
	$(chkDef "TRUE") "$CA_SPEEDCRUNCH" "$CD_SPEEDCRUNCH" \
	...
	$(chkDef "TRUE") "$CA_POWERSHELL" "$CD_POWERSHELL" \
	...
	$(chkDef "TRUE") "$CA_MYSQLWB" "$CD_MYSQLWB" \
	...
	$(chkDef "TRUE") "$CA_VERACRYPT" "$CD_VERACRYPT" \
	$(chkDef "TRUE") "$CA_WAKEONLAN" "$CD_WAKEONLAN" \
	...
	$(chkDef "TRUE") "$CA_NOTEPADQQ" "$CD_NOTEPADQQ" \
	$(chkDef "TRUE") "$CA_PYCHARM" "$CD_PYCHARM" \
	...
	$(chkDef "TRUE") "$CA_TEXSTUDIO" "$CD_TEXSTUDIO" \
	...
	$(chkDef "TRUE") "$CA_EXTINCTIONAUTO" "$CD_EXTINCTIONAUTO" \
	...
	$(chkDef "TRUE") "$CA_GS_AUGMENTATIONCAPTURE" "$CD_GS_AUGMENTATIONCAPTURE" \
	$(chkDef "FALSE") "$CA_GS_MINIMISATIONFENETRE" "$CD_GS_MINIMISATIONFENETRE" \
	$(chkDef "TRUE") "$CA_GRUBCUSTOMIZER" "$CD_GRUBCUSTOMIZER" \
	$(chkDef "FALSE") "$CA_GRUBDEFAULT" "$CD_GRUBDEFAULT" \
	$(chkDef "TRUE") "$CA_GRUBATTENTE" "$CD_GRUBATTENTE" \
